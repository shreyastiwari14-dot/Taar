  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        <p className="font-mono text-xs text-[#E8593C] tracking-widest uppercase mb-4">Analytics</p>
        <h2 className="text-white text-2xl font-semibold mb-3">Coming soon for Pro users</h2>
        <p className="text-white/40 text-sm mb-8">
          Full click analytics with 7-day charts are on the way. Upgrade to Pro to be first in line.
        </p>
