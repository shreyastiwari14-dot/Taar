  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-white/30 text-xs mb-8">per month · cancel anytime</p>
        <ul className="space-y-3 mb-10" aria-label="Pro plan features">
          {[
            ...
            'UPI QR code on your page',
            'Page QR code download',
        ...
        <p className="text-center text-white/20 text-xs mt-3">Powered by Razorpay · No hidden charges</p>
      </div>
    </div>
  )
}
